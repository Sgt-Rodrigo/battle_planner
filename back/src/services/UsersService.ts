...
// import sendConfirmedRegistEmail from "./mailerService";
   ...
   async getUsers():Promise<User[]> {
    ...
    async createUser(userData:UserDTO, password:string):Promise<IUser> {
       ...
       try {
         ...
         //*? for users table creates and save a newUser, also returns newUser back
         const user = UserRepository.create(newUser);   
         await UserRepository.save(newUser);  
         
        //  //w Send confirmation email (disabled)
        //   sendConfirmedRegistEmail({
        //     email: newUser.email,
